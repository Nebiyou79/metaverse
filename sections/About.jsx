    ...
    <motion.div
      ...
      className={`${styles.innerWidth} mx-auto ${styles.flexCenter} flex-col`}>
        ...
        className="mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white ">
            ...
            can enjoy the virtual world by feeling like
            it's really real, you can feel what you feel in this
            ...
            <span className="font-extrabold text-white"> explore </span>
             the metaverse world you want, turn 
            your dreams into reality, Let's explore the madness of
        ...
        src="/arrow-down.svg"
        alt="arrow-down"
        className="w-[81px] h-[28px] object-contain mt-[28px]"
        >
